              ...
              <div class="o-feed">
                ...
                ">
                    ...
                    <div style="display: flex; gap: var(--space-2)">
                      <a href="${pageContext.request.contextPath}/student/community" class="c-btn c-btn--ghost"><i
                          data-lucide="arrow-left"></i> All Posts</a>
                  ...
                  <nav class="c-tabs-line" aria-label="Filter">
                    ...
                    <a href="${pageContext.request.contextPath}/student/community/my-posts" class="is-active">My
                      Posts</a>
                  </nav>
                  <!-- Filters -->
                  <div class="c-filters u-stack-2" role="search" style="margin-top: var(--space-4)">
                    <div class="o-inline" style="display: flex; gap: var(--space-3); flex-wrap: wrap">
                      <input type="search" class="c-input c-input--soft js-post-search" placeholder="Search my posts"
                        aria-label="Search posts" style="min-width: 220px" />
                      <select class="c-input c-input--soft js-post-subject" aria-label="Filter by subject">
                        <option value="">All subjects</option>
                      </select>
                      <select class="c-input c-input--soft js-post-type" aria-label="Filter by type">
                    ...
                    <c:choose>
                      <c:when test="${empty posts}">
                        <div class="c-empty-state" style="text-align: center; padding: var(--space-8);">
                          ...
                          <p class="u-text-muted" style="margin-top: var(--space-4);">You haven't created any posts yet.
                          </p>
                          <a href="${pageContext.request.contextPath}/student/community/posts/create"
                            class="c-btn c-btn--secondary" style="margin-top: var(--space-4);">
                      ...
                      <c:otherwise>
                        <c:forEach var="post" items="${posts}">
                          <article
                            ...
                            <div class="c-post__head">
                              ...
                              <div style="flex: 1">
                                ...
                                <c:if test="${post.deleted}">
                                  <span class="c-badge c-badge--danger"
                                    style="margin-left: var(--space-2); font-size: 0.7rem; vertical-align: middle;">Deleted</span>
                                </c:if>
                              ...
                              <c:if test="${!post.deleted}">
                                <div class="c-post__manage">
                                  <a href="${pageContext.request.contextPath}/student/community/edit-post?id=${post.id}"
                                    class="c-btn c-btn--ghost c-btn--sm" aria-label="Edit post"><i
                                      data-lucide="edit-2"></i></a>
                                  <button class="c-btn c-btn--ghost c-btn--sm js-delete-post" aria-label="Delete post"
                            ...
                            <c:if test="${post.deleted}">
                              <div
                                style="display: flex; align-items: center; gap: var(--space-2); color: #ef4444; font-size: 0.85rem; font-weight: 500; padding: var(--space-2); background: rgba(239, 68, 68, 0.05); border-radius: 6px; margin-top: 1rem;">
