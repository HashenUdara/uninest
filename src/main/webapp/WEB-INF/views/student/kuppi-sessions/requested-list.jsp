...
<layout:student-dashboard pageTitle="Kuppi Sessions" activePage="kuppi-sessions">
    ...
    <header class="c-page__header">
        ...
        <div
          ...
          >
            <div>
              <h1 class="c-page__title">Requested Kuppi Sessions</h1>
          ...
          <nav class="c-tabs-line" aria-label="Navigation">
            ...
            <a href="${pageContext.request.contextPath}/student/kuppi-sessions/requested-list" class="is-active">Request Session</a>
  ...
  <!-- Filter Bar -->
        ...
        <div class="k-results-header">
          <span class="k-results-count" id="results-count">
            <strong>5</strong> sessions found
          </span>
        </div>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".k-session").forEach((card) => {
          card.addEventListener("click", (e) => {
            ...
            window.location.href = "${pageContext.request.contextPath}/student/kuppi-sessions/requested-session-details";
          });
        });
