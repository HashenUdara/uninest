...
<layout:auth title="Create Community">
  <h1 class="c-auth__title">Create your community</h1>
  <c:if test="${not empty error}">
    <div class="c-field__error" style="text-align: center; font-size: var(--fs-sm); margin-bottom: var(--space-4);">${error}</div>
  </c:if>
  <form class="c-auth__form js-auth-form" method="post" action="${pageContext.request.contextPath}/moderator/community/create" novalidate>
    <div class="c-field" style="grid-column: 1 / -1;">
      <label for="title" class="c-field__label">Community title</label>
    ...
    <div class="c-field" style="grid-column: 1 / -1;">
      ...
      <textarea id="description" name="description" class="c-field__input" rows="4" placeholder="Tell members what this community is about"></textarea>
