        ...
        <layout:moderator-dashboard pageTitle="Manage Subjects" activePage="subjects">
          ...
          <header class="c-page__header">
            ...
            <div class="c-toolbar">
              ...
              <div class="c-view-switch" role="group" aria-label="View switch">
                <a class="c-view-switch__btn is-active" href="${pageContext.request.contextPath}/moderator/subjects"
                  aria-current="page">
          ...
          <section>
            ...
            <c:forEach items="${subjects}" var="subject">
              ...
              <article class="c-card" data-code="${subject.code}" data-name="${subject.name}"
                data-description="${subject.description}" data-credits="${subject.credits}">
                <div class="c-card__media c-subj-thumb"></div>
                <div class="c-card__body">
                  <span class="c-status is-${subject.status}">${subject.status}</span>
                  <h3 class="c-card__title" style="cursor: pointer;"
                    onclick="window.location.href='${pageContext.request.contextPath}/moderator/topics?subjectId=${subject.subjectId}'">
                    ${subject.code} - ${subject.name} - ${subject.credits} Credits</h3>
                  <p class="c-card__meta">Academic year ${subject.academicYear} • Semester ${subject.semester}</p>
                  <div class="c-card__actions">
                    <a href="${pageContext.request.contextPath}/moderator/topics?subjectId=${subject.subjectId}"
                      class="c-icon-btn" aria-label="View topics">
                      <i data-lucide="folder"></i>
                    </a>
                    <a href="${pageContext.request.contextPath}/moderator/subject-coordinators?subjectId=${subject.subjectId}"
                      class="c-icon-btn" aria-label="Assign coordinators">
                      <i data-lucide="user-plus"></i>
                    </a>
                    <a href="${pageContext.request.contextPath}/moderator/subjects/edit?id=${subject.subjectId}"
                      class="c-icon-btn" aria-label="Edit subject">
                      <i data-lucide="pencil"></i>
                    </a>
                    <form method="post" action="${pageContext.request.contextPath}/moderator/subjects/delete"
                      style="display:inline;"
                      onsubmit="return confirm('Are you sure you want to delete this subject? All topics under it will also be deleted.');">
