            ...
            <div class="o-feed">
              <header class="c-page__header">
                ...
                ">
                  ...
                  <div style="display: flex; gap: var(--space-2)">
                    <a href="${pageContext.request.contextPath}/student/community/my-posts"
                      class="c-btn c-btn--ghost"><i data-lucide="arrow-left"></i> Back</a>
              ...
              <section class="u-stack-4">
                <article aria-label="Edit post">
                  ...
                  <form action="${pageContext.request.contextPath}/student/community/edit-post?id=${post.id}"
                    ...
                    <div class="c-field">
                      ...
                      <textarea id="post-desc" name="content" class="c-textarea c-textarea--soft" rows="6"
                        placeholder="Write a description" required><c:out value="${post.content}"/></textarea>
                    </div>

                    <div class="c-field">
                      <label for="post-subject" class="c-label">Subject</label>
                      <select id="post-subject" class="c-input c-input--soft c-input--rect">
                      ...
                      <div class="c-field" id="current-image-wrap">
                        ...
                        ">
                          <img src="${pageContext.request.contextPath}/uploads/${post.imageUrl}"
                            alt="Current post image" style="width: 100%; display: block" />
                        </div>
                      </div>
                    </c:if>
                    ...
                    <c:if test="${not empty post.poll}">
                      <div class="c-field">
                        <label class="c-label">Poll (Read-only)</label>
                        <div class="c-poll"
                          style="border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: var(--space-3); background: var(--color-surface);">
                          ...
                          <div class="u-stack-2">
                            <c:forEach var="option" items="${post.poll.options}">
                              <div
                                style="padding: var(--space-2); background: var(--color-bg); border: 1px solid var(--color-border); border-radius: var(--radius-sm);">
                                ${option.optionText}
                                <c:if test="${post.poll.currentUserVoted}">
                                  <span class="u-text-muted" style="float: right;">${option.voteCount} votes
                                    (${option.votePercentage}%)</span>
                                </c:if>
                              </div>
                            </c:forEach>
                          </div>
                    ...
                    <div class="c-field">
                      ...
                      <div class="c-dropzone" id="dropzone">
                        <input id="upload-input" name="image" type="file" accept="image/*" hidden />
                    ...
                    <div class="c-form-actions">
                      <a href="${pageContext.request.contextPath}/student/community/my-posts" class="c-btn c-btn--ghost"
